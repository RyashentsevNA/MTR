...
def get_properties_by_eotd_id(eotd):
    header = {'Authorization': authorization()}
    params = {'eotd': eotd}
    request = requests.get('https://esmtr24.sdi-solution.ru/sdi/rs/meta/AttributeClassifierReadService/getPropertiesByEotdId', params=params,
                           headers=header).json()
...
def test_get_subscribe_info_by_exchange_class(exchangeClassCodes):
...
test_get_subscribe_info_by_exchange_class(["MaterialClassifiers_Export", "Materials_Export", "RegulationDocs_Export"])
# test_get_subscribe_info(18841)
# get_subscribe_info(18841)

# test_get_material_orders_info(5527)
# get_subscribe_info(18841)
# get_attributes(5517)
